class Solution {
    // there is an important NOTE by the return statement (pls read)
private:
...
public:
    std::string smallestPalindrome(std::string s, long long k) {
        ...
        // I didnt solve this, just pasted it from editorial cuz uhm i didnt wanted to break the streak ;)
    }
};